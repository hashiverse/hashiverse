...
export const Smilie = Extension.create({
	name: "Smilie",
	...
	addInputRules() {
		return [
			...
			textInputRule({ find: /\/love$/, replace: "💕" }),
			textInputRule({ find: /\/you$/, replace: "🫵" }),
			textInputRule({ find: /\/lol$/, replace: "😂" }),
			textInputRule({ find: /\/rofl$/, replace: "🤣" }),
			textInputRule({ find: /\/sigh$/, replace: "😮‍💨" }),
			textInputRule({ find: /\/yes$/, replace: "👍" }),
			textInputRule({ find: /\/no$/, replace: "👎" }),
